  export const calculateTotals = (cart) => {
    ...
    const discountRate = cart.reduce((sum,item) => sum + parseFloat(item.total_price),0);

    const overallTotal = cart.reduce((sum, item) => sum + parseFloat(item.overallin), 0);
    console.log('overallTotal',overallTotal)
    const discountedOverallTotal = overallTotal - discountRate;
