              ...
              <StyledTable >
                <thead>
                  <tr>
                    ...
                    <th>Net Total : <span className='verall-total'></span>{totals.overallTotal.toFixed(2)}</th>
                    <th>Discount Total : <span className='bill-rate'></span>{totals.discountRate.toFixed(2)}</th>
                    <th>
